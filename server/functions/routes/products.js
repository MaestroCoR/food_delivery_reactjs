...
router.post("/create", async (req, res) => {
  try {
    ...
    return res.send({ success: false, msg: `Помилка: ${err}` });
  }
});
...
//Оновити корзину для зміни кількості продуктів
...
//Отримати весь вміст корзини для користувача
    ...
    shipping_options: [
      {
        shipping_rate_data: {
          ...
          display_name: "Безкоштовна доставка",
          delivery_estimate: {
